...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedCities() {
        ...
        // --- Udaipur ---
        City udaipur = cityRepository.save(City.builder().name("Udaipur").state("Rajasthan").tagline("City of Lakes").description("Romantic lakeside city with palatial heritage").category("Heritage").rating(4.8).bestTime("Sep-Mar").language("Hindi, Mewari").imageUrl("https://plus.unsplash.com/premium_photo-1697729844084-c03db2377161?q=80&w=869&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D").build());
        placeRepository.saveAll(List.of(
        ...
        // --- Kerala ---
        City kerala = cityRepository.save(City.builder().name("Kerala").state("Kerala").tagline("God's Own Country").description("Backwaters, beaches, and lush greenery").category("Nature").rating(4.8).bestTime("Sep-Mar").language("Malayalam").imageUrl("https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8S0VSQUxBfGVufDB8fDB8fHww").build());
        placeRepository.saveAll(List.of(
        ...
        // --- Kolkata ---
        City kolkata = cityRepository.save(City.builder().name("Kolkata").state("West Bengal").tagline("City of Joy").description("India's cultural capital known for literature, art, Durga Puja, and the sweetest sweets in India.").category("Metro").rating(4.4).bestTime("Oct-Mar").language("Bengali, English").imageUrl("https://images.unsplash.com/photo-1716470061387-d32570b54e69?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzh8fEtPTEtBVEF8ZW58MHx8MHx8fDA%3D").build());
        ...
        // --- Leh-Ladakh ---
        City leh = cityRepository.save(City.builder().name("Leh-Ladakh").state("Ladakh").tagline("Land of High Passes").description("Breathtaking high-altitude desert with Buddhist monasteries, pristine lakes, and the world's highest motorable roads.").category("Mountain").rating(4.9).bestTime("Jun-Sep").language("Ladakhi, Hindi").imageUrl("https://plus.unsplash.com/premium_photo-1661962344178-19930ba15492?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8TEVILUxBREFLSHxlbnwwfHwwfHx8MA%3D%3D").build());
